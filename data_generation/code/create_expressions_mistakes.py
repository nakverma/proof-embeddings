...
class AndNode(N_aryNode):
    ...
    def __init__(self, parent, operands=None):
        ...
        self.token = "∧"
        self.nodeOps = set([15,16,17,18,19,41,42,54,56,60,59])
...
class OrNode(N_aryNode):
    ...
    def demorgan3(self):
        ...
        #     return False
        #
        # if isinstance(self.operands[0], NotNode) and isinstance(self.operands[1], NotNode):
        #     l = self.operands[0].arg.copy()
        #     r = self.operands[1].arg.copy()
        #     notnode = NotNode(self.parent)
...
class LogicTree():
    ...
    def __init__(self, postfix_tree=None, blowup_control=True, op_seq=None, op_pairs=True):
        ...
        self.LOGICAL_EQUIVALENCE = [23,26,61,63]
        ...
        self.reductive_ops = set([26,48,49,50,52,53,58,59,62,60])
